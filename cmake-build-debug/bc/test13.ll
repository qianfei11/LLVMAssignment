...
14:                                               ; preds = %3
  store i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)* @foo, i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)** %9, align 8, !dbg !79
  br label %21, !dbg !81

15:                                               ; preds = %3
  %16 = load i8, i8* %4, align 1, !dbg !82
  %17 = sext i8 %16 to i32, !dbg !82
  %18 = icmp eq i32 %17, 45, !dbg !84
  br i1 %18, label %19, label %20, !dbg !85

19:                                               ; preds = %15
  store i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)* @clever, i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)** %9, align 8, !dbg !86
  br label %20, !dbg !88
...
21:                                               ; preds = %20, %14
  %22 = load i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)*, i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)** %9, align 8, !dbg !89
  %23 = load i32, i32* %5, align 4, !dbg !90
  %24 = load i32, i32* %6, align 4, !dbg !91
  %25 = load i32 (i32, i32)*, i32 (i32, i32)** %7, align 8, !dbg !92
  %26 = load i32 (i32, i32)*, i32 (i32, i32)** %8, align 8, !dbg !93
  %27 = call i32 (i32, i32)* %22(i32 %23, i32 %24, i32 (i32, i32)* %25, i32 (i32, i32)* %26), !dbg !89
  store i32 (i32, i32)* %27, i32 (i32, i32)** %10, align 8, !dbg !94
  %28 = load i32 (i32, i32)*, i32 (i32, i32)** %10, align 8, !dbg !95
  %29 = load i32, i32* %5, align 4, !dbg !96
  %30 = load i32, i32* %6, align 4, !dbg !97
  %31 = call i32 %28(i32 %29, i32 %30), !dbg !95
  ret i32 0, !dbg !98
}
...
!1 = !DIFile(filename: "test13.c", directory: "/Users/assassinq/CLionProjects/LLVMAssignment/cmake-build-debug/test")
!2 = !{}
...
!56 = distinct !DISubprogram(name: "moo", scope: !1, file: !1, line: 17, type: !57, scopeLine: 17, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!57 = !DISubroutineType(types: !58)
!58 = !{!13, !59, !13, !13}
!59 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!60 = !DILocalVariable(name: "x", arg: 1, scope: !56, file: !1, line: 17, type: !59)
!61 = !DILocation(line: 17, column: 14, scope: !56)
!62 = !DILocalVariable(name: "op1", arg: 2, scope: !56, file: !1, line: 17, type: !13)
!63 = !DILocation(line: 17, column: 21, scope: !56)
!64 = !DILocalVariable(name: "op2", arg: 3, scope: !56, file: !1, line: 17, type: !13)
!65 = !DILocation(line: 17, column: 30, scope: !56)
!66 = !DILocalVariable(name: "a_fptr", scope: !56, file: !1, line: 18, type: !34)
!67 = !DILocation(line: 18, column: 11, scope: !56)
!68 = !DILocalVariable(name: "s_fptr", scope: !56, file: !1, line: 19, type: !34)
!69 = !DILocation(line: 19, column: 11, scope: !56)
!70 = !DILocalVariable(name: "goo_ptr", scope: !56, file: !1, line: 20, type: !71)
!71 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !32, size: 64)
!72 = !DILocation(line: 20, column: 14, scope: !56)
!73 = !DILocalVariable(name: "t_fptr", scope: !56, file: !1, line: 21, type: !34)
!74 = !DILocation(line: 21, column: 11, scope: !56)
!75 = !DILocation(line: 23, column: 9, scope: !76)
!76 = distinct !DILexicalBlock(scope: !56, file: !1, line: 23, column: 9)
!77 = !DILocation(line: 23, column: 11, scope: !76)
!78 = !DILocation(line: 23, column: 9, scope: !56)
!79 = !DILocation(line: 24, column: 16, scope: !80)
!80 = distinct !DILexicalBlock(scope: !76, file: !1, line: 23, column: 19)
!81 = !DILocation(line: 25, column: 5, scope: !80)
!82 = !DILocation(line: 26, column: 14, scope: !83)
!83 = distinct !DILexicalBlock(scope: !76, file: !1, line: 26, column: 14)
!84 = !DILocation(line: 26, column: 16, scope: !83)
!85 = !DILocation(line: 26, column: 14, scope: !76)
!86 = !DILocation(line: 27, column: 16, scope: !87)
!87 = distinct !DILexicalBlock(scope: !83, file: !1, line: 26, column: 24)
!88 = !DILocation(line: 28, column: 5, scope: !87)
!89 = !DILocation(line: 30, column: 14, scope: !56)
!90 = !DILocation(line: 30, column: 22, scope: !56)
!91 = !DILocation(line: 30, column: 27, scope: !56)
!92 = !DILocation(line: 30, column: 32, scope: !56)
!93 = !DILocation(line: 30, column: 40, scope: !56)
!94 = !DILocation(line: 30, column: 12, scope: !56)
!95 = !DILocation(line: 31, column: 5, scope: !56)
!96 = !DILocation(line: 31, column: 12, scope: !56)
!97 = !DILocation(line: 31, column: 17, scope: !56)
!98 = !DILocation(line: 33, column: 5, scope: !56)
