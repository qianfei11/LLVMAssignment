...
13:                                               ; preds = %1
  %14 = load i32 (i32, i32)*, i32 (i32, i32)** %4, align 8, !dbg !57
  store i32 (i32, i32)* %14, i32 (i32, i32)** %5, align 8, !dbg !59
  br label %15

15:                                               ; preds = %13, %11
  %16 = load i32 (i32, i32)*, i32 (i32, i32)** %5, align 8, !dbg !60
  %17 = icmp ne i32 (i32, i32)* %16, null, !dbg !62
  br i1 %17, label %18, label %23, !dbg !63

18:                                               ; preds = %15
  call void @llvm.dbg.declare(metadata i32* %8, metadata !64, metadata !DIExpression()), !dbg !67
  %19 = load i32 (i32, i32)*, i32 (i32, i32)** %5, align 8, !dbg !68
  %20 = load i32, i32* %6, align 4, !dbg !69
  %21 = load i32, i32* %7, align 4, !dbg !70
  %22 = call i32 %19(i32 %20, i32 %21), !dbg !68
  store i32 %22, i32* %8, align 4, !dbg !67
  br label %23, !dbg !71
...
!1 = !DIFile(filename: "test02.c", directory: "/Users/assassinq/CLionProjects/LLVMAssignment/cmake-build-debug/test")
!2 = !{}
!3 = !{!4}
...
!58 = distinct !DILexicalBlock(scope: !50, file: !1, line: 19, column: 12)
!59 = !DILocation(line: 20, column: 15, scope: !58)
!60 = !DILocation(line: 23, column: 9, scope: !61)
!61 = distinct !DILexicalBlock(scope: !33, file: !1, line: 23, column: 9)
!62 = !DILocation(line: 23, column: 16, scope: !61)
!63 = !DILocation(line: 23, column: 9, scope: !33)
!64 = !DILocalVariable(name: "result", scope: !65, file: !1, line: 24, type: !66)
!65 = distinct !DILexicalBlock(scope: !61, file: !1, line: 23, column: 25)
!66 = !DIBasicType(name: "unsigned int", size: 32, encoding: DW_ATE_unsigned)
!67 = !DILocation(line: 24, column: 17, scope: !65)
!68 = !DILocation(line: 24, column: 26, scope: !65)
!69 = !DILocation(line: 24, column: 33, scope: !65)
!70 = !DILocation(line: 24, column: 38, scope: !65)
!71 = !DILocation(line: 25, column: 5, scope: !65)
!72 = !DILocation(line: 26, column: 4, scope: !33)
