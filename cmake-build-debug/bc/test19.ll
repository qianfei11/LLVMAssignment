...
; Function Attrs: noinline nounwind optnone ssp uwtable
define i32 @clever() #0 !dbg !45 {
  %1 = alloca i32 (i32, i32, i32 (i32, i32)*)*, align 8
  %2 = alloca i32 (i32, i32)*, align 8
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32 (i32, i32, i32 (i32, i32)*)** %1, metadata !48, metadata !DIExpression()), !dbg !50
  store i32 (i32, i32, i32 (i32, i32)*)* null, i32 (i32, i32, i32 (i32, i32)*)** %1, align 8, !dbg !50
  call void @llvm.dbg.declare(metadata i32 (i32, i32)** %2, metadata !51, metadata !DIExpression()), !dbg !52
  store i32 (i32, i32)* null, i32 (i32, i32)** %2, align 8, !dbg !52
  store i32 (i32, i32, i32 (i32, i32)*)* @foo, i32 (i32, i32, i32 (i32, i32)*)** %1, align 8, !dbg !53
  ...
  store i32 2, i32* %4, align 4, !dbg !57
  %6 = load i32, i32* %3, align 4, !dbg !58
  %7 = icmp sgt i32 %6, 0, !dbg !60
  br i1 %7, label %8, label %9, !dbg !61

8:                                                ; preds = %0
  store i32 (i32, i32)* @plus, i32 (i32, i32)** %2, align 8, !dbg !62
  br label %10, !dbg !63

9:                                                ; preds = %0
  store i32 (i32, i32)* @minus, i32 (i32, i32)** %2, align 8, !dbg !64
  br label %10

10:                                               ; preds = %9, %8
  call void @llvm.dbg.declare(metadata i32* %5, metadata !65, metadata !DIExpression()), !dbg !67
  %11 = load i32 (i32, i32, i32 (i32, i32)*)*, i32 (i32, i32, i32 (i32, i32)*)** %1, align 8, !dbg !68
  %12 = load i32, i32* %3, align 4, !dbg !69
  %13 = load i32, i32* %4, align 4, !dbg !70
  %14 = load i32 (i32, i32)*, i32 (i32, i32)** %2, align 8, !dbg !71
  %15 = call i32 %11(i32 %12, i32 %13, i32 (i32, i32)* %14), !dbg !68
  store i32 %15, i32* %5, align 4, !dbg !67
  ret i32 0, !dbg !72
}
...
!1 = !DIFile(filename: "test19.c", directory: "/Users/assassinq/CLionProjects/LLVMAssignment/cmake-build-debug/test")
!2 = !{}
...
!39 = !DILocalVariable(name: "fptr", arg: 3, scope: !31, file: !1, line: 12, type: !34)
!40 = !DILocation(line: 12, column: 27, scope: !31)
!41 = !DILocation(line: 14, column: 9, scope: !31)
!42 = !DILocation(line: 14, column: 14, scope: !31)
!43 = !DILocation(line: 14, column: 16, scope: !31)
!44 = !DILocation(line: 14, column: 2, scope: !31)
!45 = distinct !DISubprogram(name: "clever", scope: !1, file: !1, line: 16, type: !46, scopeLine: 16, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!46 = !DISubroutineType(types: !47)
!47 = !{!13}
!48 = !DILocalVariable(name: "af_ptr", scope: !45, file: !1, line: 18, type: !49)
!49 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !32, size: 64)
!50 = !DILocation(line: 18, column: 11, scope: !45)
!51 = !DILocalVariable(name: "pf_ptr", scope: !45, file: !1, line: 19, type: !34)
!52 = !DILocation(line: 19, column: 11, scope: !45)
!53 = !DILocation(line: 20, column: 11, scope: !45)
!54 = !DILocalVariable(name: "op1", scope: !45, file: !1, line: 21, type: !13)
!55 = !DILocation(line: 21, column: 9, scope: !45)
!56 = !DILocalVariable(name: "op2", scope: !45, file: !1, line: 21, type: !13)
!57 = !DILocation(line: 21, column: 18, scope: !45)
!58 = !DILocation(line: 23, column: 9, scope: !59)
!59 = distinct !DILexicalBlock(scope: !45, file: !1, line: 23, column: 9)
!60 = !DILocation(line: 23, column: 13, scope: !59)
!61 = !DILocation(line: 23, column: 9, scope: !45)
!62 = !DILocation(line: 24, column: 12, scope: !59)
!63 = !DILocation(line: 24, column: 6, scope: !59)
!64 = !DILocation(line: 26, column: 12, scope: !59)
!65 = !DILocalVariable(name: "result", scope: !45, file: !1, line: 28, type: !66)
!66 = !DIBasicType(name: "unsigned int", size: 32, encoding: DW_ATE_unsigned)
!67 = !DILocation(line: 28, column: 14, scope: !45)
!68 = !DILocation(line: 28, column: 23, scope: !45)
!69 = !DILocation(line: 28, column: 30, scope: !45)
!70 = !DILocation(line: 28, column: 35, scope: !45)
!71 = !DILocation(line: 28, column: 39, scope: !45)
!72 = !DILocation(line: 29, column: 5, scope: !45)
